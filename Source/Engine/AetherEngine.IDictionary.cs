...
{
    public partial class AetherEngine : IDictionary<UniqueID, IAether>
    {
        // a global collection of all particles in the engine
        ...
        {
            return particles.TryGetValue(key, out value);
        }
        ...
        public UniqueID GetParticleUID(IAether particle)
        {
            foreach (UniqueID key in particles.Keys)
                if (particles[key] == particle) return key;
